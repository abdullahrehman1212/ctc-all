...
const AreaNegative = ({ dataMain, dataLoading }) => {
	...
	const [graphDataExpenseCost, setGraphDataExpenseCost] = useState([]);
	...
	useEffect(() => {
		...
		setGraphDataExpenseCost(dataListExpenseCost.reverse());
	...
	}, [graphCategories, graphDataCost, graphDataExpense, graphDataExpenseCost, graphDataRevenue]);
