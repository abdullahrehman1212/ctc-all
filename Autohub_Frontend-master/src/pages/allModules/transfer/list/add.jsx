...
const Add = ({ refreshTableData }) => {
	...
	const [storeTypeOptionsLoading, setStoreTypeOptionsLoading] = useState(true);
	...
	// const clearItemsNUnit = (idx) => {
	// 	formik.setFieldValue(`list[${idx}].item_id`, '');
	// 	formik.setFieldValue(`list[${idx}].qty_transferred`, '');
	...
	const submitForm = (myFormik) => {
		setIsLoading(true);
		apiClient
			.post(`/addNewTransfer`, myFormik.values)
			.then((res) => {
		...
		<div className='col-auto'>
			...
			<Modal
				...
				<ModalHeader setIsOpen={headerCloseStatus ? setState : null}>
					<CardLabel icon='Add'>
						<ModalTitle id='exampleModalLabel'>Add Transfer</ModalTitle>
					</CardLabel>
				</ModalHeader>
				<ModalBody>
											...
											<div className='col-md-6  border-end'>
												...
												<FormGroup
													...
													<Select
														...
														invalidFeedback={
															formik.errors.transfer_from_store_type
														}
													/>
												</FormGroup>
												<FormGroup
											...
											<div className='col-md-6  border-start'>
												...
												<FormGroup
													...
													<Select
														...
														invalidFeedback={
															formik.errors.transfer_to_store_type
														}
													/>
												</FormGroup>
