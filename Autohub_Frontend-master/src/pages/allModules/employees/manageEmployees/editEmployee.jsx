...
import { ModalTitle } from '../../../../components/bootstrap/Modal';
...
const AddCoeSubGroup = (props) => {
	...
	const submitForm = (myFormik) => {
		apiClient
			.post(`/updateEmployee`, myFormik.values, {})
			...
			<Card stretch tag='form' onSubmit={formik.handleSubmit}>
				<div className='row g-4'>
					<CardBody className='col-md-6 border-end'>
									...
									<Select
										...
										value={
											...
											employeeTypesOptions.find(
												(c) => c.value === formik.values.employee_type_id,
											)
										}
										// value={formik.values.mouza_id}
										onChange={(val) => {
						...
						<br />
						<div className='row g-4'>
							<FormGroup id='father_name' label='Father Name  ' className='col-md-6'>
								<Input
									onChange={formik.handleChange}
									onBlur={formik.handleBlur}
					...
					<CardBody className='col-md-6 border-start'>
						...
						<div className='row g-4'>
							...
							<FormGroup
								...
								<Input
									...
									invalidFeedback={formik.errors.late_fine_percentage_per_hour}
									validFeedback='Looks good!'
								/>
							</FormGroup>
						</div>
						...
						<br />
						<div className='row g-4'>
							<FormGroup id='bank_name' label='Bank Name' className='col-md-6'>
								<Input
									onChange={formik.handleChange}
									onBlur={formik.handleBlur}
							...
							<FormGroup id='bank_branch' label='Bank Branch' className='col-md-6'>
								<Input
									onChange={formik.handleChange}
									onBlur={formik.handleBlur}
