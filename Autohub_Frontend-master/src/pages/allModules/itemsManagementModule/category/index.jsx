...
const Categories = () => {
	...
	const refreshTableData = () => {
		...
		apiClient
			.get(
				`/getCategories?records=${store.data.itemsManagementModule.category.perPage}&pageNo=${store.data.itemsManagementModule.category.pageNo}&colName=id&sort=desc`,
				{},
			)
			.then((response) => {
	...
	useEffect(() => {
		...
		store.data.itemsManagementModule.category.perPage,
		store.data.itemsManagementModule.category.pageNo,
	]);
