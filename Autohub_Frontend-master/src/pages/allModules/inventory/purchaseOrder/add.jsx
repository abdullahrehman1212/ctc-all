...
const Add = ({ refreshTableData, setCounter, counter, setSelectedStore, setSelectedName }) => {
	...
	// console.log('racks data here:', racks);
	...
	useEffect(() => {
		...
		// eslint-disable-next-line react-hooks/exhaustive-deps
	}, [formik.values.supplier_id, counter1]);
	...
	useEffect(() => {
		...
		apiClient
			...
			.then((response) => {
				console.log('The mechine part model dropdown in add:', response);
