...
const validate = (values) => {
	...
	// 	if (Number(data.existingQty) < Number(data.reqQty) * Number(values.out_flow)) {
	// 		errors = {
	// 			...errors,
								...
								<div className='row g-2'>
									...
									<div className='col-md-12'>
												...
												<tbody>
													{formik.values.tableData.map((item, index) => (
														<tr key={item.id}>
															...
															<td>
																{item.reqQty} *{' '}
																{formik.values.out_flow}=
																{item.reqQty *
																	formik.values.out_flow ?? 0}
															</td>
															<td>
																{item.existingQty}
																{formik.errors[
										...
										<div className='row '>
											...
											<FormGroup label='' className='col-md-6 mt-2 ml-6 '>
												<Label> Break Qty</Label>
											</FormGroup>

											<FormGroup id='out_flow' label='' className='col-md-6'>
												<Label>
