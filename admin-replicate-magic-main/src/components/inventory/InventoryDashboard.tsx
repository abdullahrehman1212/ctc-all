...
// Empty arrays for dashboard items
const lowStockItems: { id: number; partNo: string; name: string; category: string; qty: number; minQty: number; brand: string }[] = [];

const outOfStockItems: { id: number; partNo: string; name: string; category: string; qty: number; brand: string }[] = [];

const categoryDistribution: { name: string; value: number; color: string }[] = [];

const categoryValueData: { name: string; value: number }[] = [];

const stockMovementData: { month: string; balance: number; stockIn: number; stockOut: number }[] = [];

const topBrandsByValue: { name: string; value: number }[] = [];

const topItemsByValue: { id: number; partNo: string; name: string; brand: string; qty: number; value: number }[] = [];

const topItemsByQty: { id: number; partNo: string; name: string; brand: string; qty: number; value: number }[] = [];

const storeDistribution: { store: string; items: number; qty: number; value: number; percentage: number }[] = [];

const recentAdjustments: { id: string; date: string; items: number; change: number }[] = [];
